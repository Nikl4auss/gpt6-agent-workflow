...
- [ ] An implementation trial runs with workspace-write permission selected for the parent session, and demonstrates Luna editing and running focused validation, followed by an independent Sol review verdict.
